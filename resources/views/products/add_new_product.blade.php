...
@csrf
	...
	<div class="mb-3">
		...
		<input type="number" class="form-control" id="no_of_items" name="no_of_items" placeholder="No of items" required>
	</div>

	<div class="row">
		<div class="col-12 text-right" style="text-align:right;">
			<button type="submit" class="btn btn-primary btn-pad">Save Product</button>
...
var validate1=$('#saveProduct').validate({ 
