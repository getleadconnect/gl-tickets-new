                                ...
                                <div class="float-end">
                                    <ol class="breadcrumb">
                                       <li class="breadcrumb-item"><a href="{{url('dashboard')}}">Home</a>
										...
										<li class="breadcrumb-item active"><a href="#">Closed Tickets</a>
										</li><!--end nav-item-->
                                    </ol>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="media">
												...
												@endphp
                                                   ...
                                                   <a href="javascript:;" id="{{$row->id}}" > <h4 class="mt-0 mb-1 font-16">Ticket ID : #{{$row->id}} {{ucwords($row->issue)}}&nbsp;:&nbsp;<span class="font-12" style="color:{{$color}};">{{$status}}</span></h4></a>
                                                </div><!--end media-body-->
                                            </div><!--end media-->
                                        </div><!--end col-->
                                        <div class="col-sm-6 d-flex  align-self-center flex-gap" >
                                            ...
                                            <div class="text-end">
                                                <button type="button"  class="btn btn-outline-primary btn-reopen-ticket" data-ticketid="{{$row->id}}" style="padding:4px 10px;color:red;">Reopen Ticket</button>
