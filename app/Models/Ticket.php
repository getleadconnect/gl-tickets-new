...
class Ticket extends Model
{
	...
	protected $fillable = ['id','issue','description','customer_id','priority','status','due_date','ticket_type','branch_id','tracking_number','due_date','created_by','slug','service_id','closed_time','closed_at'];
    ...
    {
        return $this->belongsToMany(TicketLabel::class,'label_ticket','ticket_id','label_id')->select('ticket_labels.id','ticket_labels.label','ticket_labels.color');
    }
